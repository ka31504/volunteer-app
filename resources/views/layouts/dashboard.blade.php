...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        body { font-family: 'Inter', sans-serif; background: var(--canvas-soft); color: var(--ink); -webkit-font-smoothing: antialiased; }
        ...
        .db-sidebar.collapsed { transform: translateX(calc(-1 * var(--sidebar-w))); }
        .sidebar-logo {
        ...
        .logo-dot { width: 8px; height: 8px; border-radius: 50%; background: var(--primary); display: inline-block; flex-shrink: 0; }
        .sidebar-nav { flex: 1; padding: 12px 0; overflow-y: auto; }
        .nav-section-label { font-size: 10px; font-weight: 500; color: var(--ink-faint); text-transform: uppercase; letter-spacing: 0.8px; padding: 12px 20px 6px; }
        .nav-item {
        ...
        .nav-item.active { background: #f0fdf8; color: var(--primary); font-weight: 500; }
        ...
        .toggle-btn:hover { background: var(--canvas-soft); color: var(--ink); }
        ...
        /* CONTENT */
        .db-content { flex: 1; padding: 28px; }
        ...
        @media (max-width: 768px) {
            .db-sidebar { transform: translateX(calc(-1 * var(--sidebar-w))); }
...
<div class="db-wrapper" id="dbWrapper">
    ...
    <aside class="db-sidebar" id="sidebar">
        ...
        <nav class="sidebar-nav">
            ...
            <a href="{{ route('statistics.export-pdf', ['year' => request('year', now()->year)]) }}" class="nav-item">
        ...
        <div class="sidebar-footer">
            <div class="sidebar-user">
                ...
                <div>
                    ...
                    <div class="user-role">{{ Auth::user()->role === 'admin' ? 'Quản trị viên' : 'Người dùng' }}</div>
                </div>
            </div>
        </div>
    </aside>
